   ...
   <div class="col-lg-5 offset-md-4 text-center">
        ...
        @method('PUT')  
                            <div class="row">
                                <div class="col-lg-12 mb-20">
                                    <div class="form-inner">
                                        <label></label>
										 <input type="text" id="password" class="form-control" name="password" placeholder="Password" required autofocus>
                            ...
                            <div class="col-lg-12 mb-20">
                                    <div class="form-inner">
                                        <label></label>
										 <input type="text" id="confirm_password" class="form-control" name="confirm_password" placeholder="Confirm Password" required autofocus>
