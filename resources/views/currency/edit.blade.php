            ...
            <div class="card-body">
              <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <input type="text" id="value" name="value" value="{{ old('value') ?: $record->value }}" class="form-control"  placeholder="Value" />
                @if ($errors->has('value'))
			  ...
			  <div class="form-group">
                ...
                <input type="text" id="markup_value" name="markup_value" value="{{ old('markup_value')?: $record->markup_value }}" class="form-control"  placeholder="Markup Value in Default Currency" />
                @if ($errors->has('value'))
                    <span class="text-danger">{{ $errors->first('value') }}</span>
                @endif
              </div>
