    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function addRow() {
                ...
                cell1.innerHTML = '<select name="duration[]" class="form-control" required><option value="" selected>0-24</option><option value="1">24-48</option><option value="2">48+</option></select>';
